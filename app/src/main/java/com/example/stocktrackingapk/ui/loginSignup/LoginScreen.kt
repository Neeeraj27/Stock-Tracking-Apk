...
fun LoginScreen(navController: NavController, viewModel: AuthViewModel) {
    ...
    // Form validation: email and password must be filled in
    val isFormValid = remember(viewModel.email, viewModel.password) {
        viewModel.email.isNotEmpty() && viewModel.password.isNotEmpty()
    }

    // Reset error message and form fields on first launch
    LaunchedEffect(Unit) {
    ...
    Box(
        ...
        Column(
            ...
            // Sign Up TextButton to navigate to the signup screen
